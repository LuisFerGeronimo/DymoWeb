...
/**
 * Modificación de la empresa en la base de datos
 * 
 ...
 * a los registros de las empresas.
 */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if( isset($_POST['id']) && 
		...
		//======================================================================
		// MODIFICACIÓN DE LOS DATOS DE LA EMPRESA
		//======================================================================
		...
		$queryGenerico->setSet('nombre = ?, telefono = ?, correo = ?');
		 ...
		 *   - 'b' -> boolean
		 */
		$queryGenerico->setParamsType(array('s', 's', 's', 'i'));
